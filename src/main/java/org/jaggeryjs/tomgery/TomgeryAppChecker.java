...
public class TomgeryAppChecker {
    ...
    /**
     * To check whether the deploying app is jaggery app or not
     * @param servletContext context which deploying in the tomcat
     * @return true if it contains jaggery.conf file
     */
